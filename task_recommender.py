...
# df = pd.read_excel("tasks.xlsx")  # or your exact filename

# # Optional: Rename columns if needed
# df.columns = ['task']  # assuming the Excel file has only one column

# # Add default priorities or read from additional columns if they exist
# df['priority'] = ['High', 'Medium', 'Medium', 'High', 'Low', 'Medium', 'Medium', 'High', 'Medium', 'High']

# # Convert to list of dictionaries
# project_plan = df.to_dict(orient='records')
...
mood_responses = {
    ...
    "a bit low": [
        ...
        "I understand you are not feeling too well today, and it is alright. You can choose the lighter tasks."
    ],
    "neutral": [
